...
As confirmed in [Define Party Registry, CRM Customer, and commerce Counterparty ownership](https://github.com/TechsioCZ/ontos/issues/95), **Party Registry** is the tenant-scoped Foundational Module for sparse or Unresolved person/organization identity, official identifiers, Contact Points, Party Relationships, Counterparty relationships and roles, matching, correction, and merge. CRM engagement profiles and workflows remain CRM-owned; Retail Customer profiles, B2B purchasing workflows, and commerce policy remain Commerce-owned. Principal authorization—not Party Relationship—decides who may buy, approve, or administer access. Provider-issued correlations remain in the owning module's Connector Registry. Shared use never removes Tenant and Legal Entity isolation, and any future cross-tenant correlation is an explicit governed link rather than one mutable global Party.
